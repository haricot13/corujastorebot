...
sem mencionar Pterodactyl, pois os iniciantes não sabem o que é (exceto se perguntarem sobre)!`,
    ...
    messages.push({
      ...
      content: fs.readFileSync(
        path.resolve(process.cwd(), "takeshi-bot-main", "AGENTS.md"),
        "utf-8",
      ),
    });
    ...
    messages.push({
      role: "system",
      content: fs.readFileSync(
        path.resolve(process.cwd(), "takeshi-bot-main", "README.md"),
        "utf-8",
      ),
    });
    ...
    messages.push({
      role: "system",
      content: fs.readFileSync(
        path.resolve(process.cwd(), "takeshi-bot-main", "package.json"),
        "utf-8",
      ),
    });
    ...
    messages.push({
      role: "system",
      content: fs.readFileSync(
        path.resolve(process.cwd(), "takeshi-bot-main", "src", "menu.js"),
        "utf-8",
      ),
    });
